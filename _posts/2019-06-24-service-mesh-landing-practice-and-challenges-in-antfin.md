...
{: refdef: style="text-align: center;"}
![图1. 分享大纲](https://jervyshi.com/assets/images/1.png)

## 蚂蚁金服当前的服务化现状
在看蚂蚁金服的服务化架构之前我们先从一个简单的服务化调用示例说起，下图是 SOFARPC 基本原理：

{: refdef: style="text-align: center;"}
![图2. SOFARPC 基本原理](https://jervyshi.com/assets/images/2.png)
...
{: refdef: style="text-align: center;"}
![图5. APP 业务与 SDK 组成部分](https://jervyshi.com/assets/images/5.png)

应用内除业务逻辑之外，由中间件的 SDK 引入大量外部依赖，来完成服务发现、路由寻址、负载均衡、限流熔断、序列化、通讯等能力，每个组件的引入都可能带来稳定性风险，以及更高的升级成本。

{: refdef: style="text-align: center;"}
![图6. SDK 内不同能力对应的依赖](https://jervyshi.com/assets/images/6.png)
...
{: refdef: style="text-align: center;"}
![图7. SDK 升级数量](https://jervyshi.com/assets/images/7.png)
...
{: refdef: style="text-align: center;"}
![图8. Java 与 NodeJS 互调](https://jervyshi.com/assets/images/8.png)

中间件 SDK 跨语言重写与维护成本极高，随着语言种类的增多，跨语言通讯的诉求也越来越多。

{: refdef: style="text-align: center;"}
![图9. 多语言场景](https://jervyshi.com/assets/images/9.png)
...
{: refdef: style="text-align: center;"}
![图10. SDK 瘦身并下沉能力至 Sidecar](https://jervyshi.com/assets/images/10.png)

依然以上述 RPC SDK 举例，SDK 中的能力我们可以根据稳定性与不可剥离等特性来看，哪些是可以从应用中抽出来的，尽量把 SDK 做薄，做的足够稳定无需变更，那么升级成本将不复存在。


{: refdef: style="text-align: center;"}
![图11. SDK 与 Sidecar 对应的依赖](https://jervyshi.com/assets/images/11.png)
...
{: refdef: style="text-align: center;"}
![图12. RPC 消息与数据源能力下沉](https://jervyshi.com/assets/images/12.png)
...
{: refdef: style="text-align: center;"}
![图13. Mesh 落地架构](https://jervyshi.com/assets/images/13.png)
...
{: refdef: style="text-align: center;"}
![图14. 落地 CPU 数据](https://jervyshi.com/assets/images/14.png)
...
{: refdef: style="text-align: center;"}
![图15. 落地方式](https://jervyshi.com/assets/images/15.png)
...
{: refdef: style="text-align: center;"}
![图16. SOFAMosn 平滑升级](https://jervyshi.com/assets/images/16.png)
...
{: refdef: style="text-align: center;"}
![图17. SOFAMosn 平滑升级流程](https://jervyshi.com/assets/images/17.png)
...
{: refdef: style="text-align: center;"}
![图18. 正常流量走向](https://jervyshi.com/assets/images/18.png)
...
{: refdef: style="text-align: center;"}
![图19. 正向流量迁移](https://jervyshi.com/assets/images/19.png)
...
{: refdef: style="text-align: center;"}
![图20. 逆向流量迁移](https://jervyshi.com/assets/images/20.png)
...
{: refdef: style="text-align: center;"}
![图21. 请求合并写](https://jervyshi.com/assets/images/21.png)
...
{: refdef: style="text-align: center;"}
![图22. 演进方向控制面结合](https://jervyshi.com/assets/images/22.png)
...
{: refdef: style="text-align: center;"}
![图23. 产品化模型](https://jervyshi.com/assets/images/23.png)
